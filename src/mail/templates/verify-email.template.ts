  ...
  <div class="email-container">
    <div class="email-header">
      <div class="brand-name">
        <img src="" alt="Total Health Logo" class="logo" />
      </div>
    </div>
    <div class="email-body">
      <h1 class="email-title">Email Verification</h1>
      <p class="email-content">Hi ${receiverName},<br>Copy the code below to verify your email.</p>
      <span class="email-link">Code: ${escapeHtml(verificationCode)}</span>
